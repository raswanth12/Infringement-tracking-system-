...
//     //     // Use the Cosine Similarity algorithm to compare the selected files
//     //     StringMetric metric = new CosineSimilarity(Tokenizers.whitespace());

//     //     //StringMetric metric = new CosineSimilarity(Tokenizer.WHITESPACE);
...
//     //                 float similarity = metric.compare(selectedFileContents.get(file1), selectedFileContents.get(file2));
...
//     StringMetric metric = new Jaccard<>(Tokenizers.whitespace(), Simplifiers.toLowerCase(Locale.ENGLISH));
